...
class TestKauppa(unittest.TestCase):
    def setUp(self) -> None:
        ...
        def varasto_hae_tuote(tuote_id):
            if tuote_id == 1:
                ...
                return Tuote(2, "potatoe", 1)
            elif tuote_id == 3:
                return Tuote(3, "carrot", 3)
    ...
    def test_tilisiirto_kutsuttu_oikeilla_argumenteilla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_tilisiirto_kutsuttu_oikeilla_argumenteilla_kun_monta_eri_tuotetta(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_tilisiirto_kutsuttu_oikeilla_argumenteilla_kun_monta_samaa_tuotetta(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_tilisiirto_kutsuttu_oikeilla_argumenteilla_kun_yksi_tuote_loppu(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
